...
public class PaymentMethodService {
    ...
    public List<PaymentMethod> getXMLList() throws JAXBException, IOException, XMLStreamException, ParserConfigurationException, SAXException {
        DataListXML data = parameterFileService.readXmlFile("classpath:parameter/xml/FormasPago-2.1.gc");
    ...
    public void generateJsonFile(){
        ...
        try {
            objectMapper.writeValue(new File(resourceLoader
                    .getResource("classpath:parameter/json/FormasPago-2.1.json")
    ...
    public List<PaymentMethod> getList() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
