...
public class TaxTypeService {
    ...
    public List<TaxType> getXMLList() throws JAXBException, IOException, XMLStreamException, ParserConfigurationException, SAXException {
        DataListXML data = parameterFileService.readXmlFile("classpath:parameter/xml/TipoImpuesto-2.1.gc");
    ...
    public void generateJsonFile(){
        ...
        try {
            objectMapper.writeValue(new File(resourceLoader
                    .getResource("classpath:parameter/json/TipoImpuesto-2.1.json")
    ...
    public List<TaxType> getList() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        File file = resourceLoader
                .getResource("classpath:parameter/json/TipoImpuesto-2.1.json")
                .getFile();
        return objectMapper.readValue(file, new TypeReference<List<TaxType>>(){});
    }
}
