...
public class TransportRecordService {
    ...
    public List<TransportRecord> getXMLList() throws JAXBException, IOException, XMLStreamException, ParserConfigurationException, SAXException {
        DataListXML data = parameterFileService.readXmlFile("classpath:parameter/xml/RegistroTransporte-2.1.gc");
    ...
    public void generateJsonFile(){
        ...
        try {
            objectMapper.writeValue(new File(resourceLoader
                    .getResource("classpath:parameter/json/RegistroTransporte-2.1.json")
    ...
    public List<TransportRecord> getList() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        File file = resourceLoader
                .getResource("classpath:parameter/json/RegistroTransporte-2.1.json")
                .getFile();
        return objectMapper.readValue(file, new TypeReference<List<TransportRecord>>(){});
    }
}
